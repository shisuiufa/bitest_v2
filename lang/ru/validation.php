...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'title' => 'наименование',
        'itn' => 'ИНН',
        'general_info.fullTitle' => 'полное наименование',
        'general_info.kpp' => 'КПП',
        'general_info.ogrn' => 'ОГРН',
        'head_info.name' => 'имя',
        'head_info.surname' => 'фамилия',
        'head_info.position' => 'должность',
        'country' => 'страна',
        'city' => 'город',
        'postal_index' => 'индекс',
        'street' => 'улица',
        'primary_phone' => 'основной телефон',
        'banking_account' => 'банковские реквизиты',
        'banking_account.bank' => 'банк',
        'banking_account.bankIdentifierCode' => 'БИК',
        'banking_account.correspondentAccount' => 'корреспондентский счет',
        'banking_account.ledgerAccount' => 'лицевой счет',
        'banking_account.settlementAccount' => 'расчетный счет',
        'stats.foundationYear' => 'год основания',
        'stats.personnelCount' => 'количество сотрудников',
        'result' => 'результат',
        'value' => 'значение',
        'percentage' => 'процент',
        'period' => 'срок',
        'editReason' => 'Причина назначения',
        'current password' => 'Текущий пароль',
        'repeated_tender_deadline' => 'срок завершения переторжки',
    ],
];
