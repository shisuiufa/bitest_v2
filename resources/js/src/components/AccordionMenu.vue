                    ...
                    <ui-button
                        :class="
                            this.selectedFilter === filter
                                ? 'accordion-menu__btn_active'
                                : null
                        "
                        class="accordion-menu__btn"
                        v-for="filter in filters"
                        :key="filter.id"
                        @click="this.selectedFilter = filter"
                        >{{ filter.name }}
                    </ui-button>
                    <ui-button
                        v-if="this.event === 'create'"
        ...
        <div class="accordion-menu__content" v-if="this.selectedFilter">
            <div class="row">
                <accordion-main-content
                    :event="this.event"
                    :testMainInfo="this.testMainInfo"
                    v-if="this.selectedFilter.value === 'main'"
                ></accordion-main-content>
                <accordion-questions
                    :testId="this.test?.id"
                    :event="this.event"
                    :testQuestions="this.testQuestions"
                    v-if="this.selectedFilter.value === 'questions'"
                ></accordion-questions>
                <accordion-access
                    :accessesTest="this.accessesTest"
                    v-if="this.selectedFilter.value === 'access'"
                ></accordion-access>
            </div>
        </div>
    </div>
