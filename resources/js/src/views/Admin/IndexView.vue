<template>
                ...
                <template #header>
                    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100">
                        ...
                        <div class="d-flex gap-1">
                            <Button icon="pi pi-external-link" class="p-button-sm fs-6 rounded" label="Добавить"
                                    @click="addUser"/>
    ...
    <Dialog v-model:visible="visible" :header="this.eventForm === 'add' ? 'Создать' : 'Обновить'"
            :style="{ width: '25rem' }">
        <CreateUserForm :userId="selectedUser" @updateDate="this.getUsers(); this.visible = false;"
